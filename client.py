...
def main(xlsx_name):
    ...
    pop_frame.to_csv("test/bigpop.csv")
    birth_frame.to_csv("test/births.csv")
    pop_child_neg.to_csv("test/child-neg.csv")
    pop_child_hiv.to_csv("test/child-hiv.csv")
    pop_adult_neg.to_csv("test/adult-neg.csv")
    pop_adult_hiv.to_csv("test/adult-hiv.csv")
    new_hiv.to_csv("test/new-hiv.csv")
    t5 = time.time()
...
if __name__ == "__main__":
    ...
    xlsx_name = "inputs\\example-unversioned_direct-hiv_spec-cd4.xlsx"
    main(xlsx_name)
